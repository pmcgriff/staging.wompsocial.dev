...
//Scroll To Me
    ...
    $('.revolutionScroll a').on('click', function(e) {
        e.preventDefault();
        var aniLocation = jQuery(this).attr('href');
        jQuery('body, html').animate({
            scrollTop : jQuery(aniLocation).offset().top
    ...
    $('.womp-overlay a').on('click', function(e) {
        e.preventDefault();
        var aniLocation = jQuery(this).attr('href');
        jQuery('body, html').animate({
            scrollTop : jQuery(aniLocation).offset().top
...
(function(window, document, undefined)
{
    ...
    window.App = (function()
    {
        ...
        app.init = function()
        {
            ...
            //modified for removal of nav-menu for womp
            if(document.getElementById('nav-open-btn') && document.getElementById('nav-close-btn')){
