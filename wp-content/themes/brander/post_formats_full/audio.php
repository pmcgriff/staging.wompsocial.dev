<?php global $porter_config; ?>
	...
	<?php if(!is_singular()) : ?>
        ...
        <div <?php post_class('large-12 columns audio'); ?>>
            <div class="newsItem">
                <?php if(has_post_thumbnail()) { the_post_thumbnail('w650'); }?>
                <div class="play">
                    <iframe width="570" height="114" src="<?php if (function_exists('rwmb_meta')):?><?php echo rwmb_meta( 'post_additional' ); ?><?php else: ?><?php endif; ?>"></iframe>
                </div>
            </div>
