	...
	<div id="toolbox_wrapper" class="toolbox_wrapper postbox unite-postbox">
		...
		<div class="toggled-content tp-closedatstart p20">
			...
			<div class="api-desc"><?php _e("Replace all layer and background image url's. Example: http://staging.wompsocial.dev/ to http://yourwbsite.com/. <br> Note, the replace is not reversible",REVSLIDER_TEXTDOMAIN)?>.</div>
						
			<div class="divide10"></div>
			
			<?php _e("Replace From (example - http://staging.wompsocial.dev)",REVSLIDER_TEXTDOMAIN)?>:
			<div class="divide5"></div>			
