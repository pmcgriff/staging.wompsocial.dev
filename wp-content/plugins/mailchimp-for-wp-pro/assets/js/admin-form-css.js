(function($) {
	...
	function applyCSS()
	{
		...
		/* paragraphs */
		maybeSet('paragraphs-font-color', $paragraphs, 'color', 'color');
		maybeSet('paragraphs-vertical-margin', $paragraphs, ['margin-top', 'margin-bottom'], 'int');
		maybeSet('paragraphs-font-size', $paragraphs, 'font-size', 'int');
