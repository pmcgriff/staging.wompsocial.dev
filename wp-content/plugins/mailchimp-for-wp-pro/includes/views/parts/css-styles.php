...
<?php echo $selector_prefix; ?>.mc4wp-form input,
<?php echo $selector_prefix; ?>.mc4wp-form textarea,
<?php echo $selector_prefix; ?>.mc4wp-form select,
<?php echo $selector_prefix; ?>.mc4wp-form button {
...
/* buttons */
<?php echo $selector_prefix; ?>.mc4wp-form input[type="submit"], 
<?php echo $selector_prefix; ?>.mc4wp-form button, 
<?php echo $selector_prefix; ?>.mc4wp-form input[type="button"], 
<?php echo $selector_prefix; ?>.mc4wp-form input[type="reset"] {
	text-shadow:none; 
	padding:6px 12px; 
	cursor: pointer; 
	text-align:center; 
